...
import kotlinx.android.synthetic.main.fragment_survey_evaluate1.view.*
import java.util.*
import kotlin.collections.HashMap


class Survey1EvaluateFragment : Fragment() {
    /*DATABASE*/
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        return inflater.inflate(R.layout.fragment_survey_evaluate1, container, false)
    }
        ...
        super.onActivityCreated(savedInstanceState)
                   ...
                   button_next.setOnClickListener {
                       ...
                       findNavController().navigate(
                               Survey1EvaluateFragmentDirections.actionSurvey1EvaluateFragmentToSurvey2EvaluateFragment()
                       )
                   }
               }
    /*DATABASE*/
