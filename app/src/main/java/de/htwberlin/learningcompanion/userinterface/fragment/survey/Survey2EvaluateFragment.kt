...
class Survey2EvaluateFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        return inflater.inflate(R.layout.fragment_survey_evaluate2, container, false)
    }
        ...
        activity?.findViewById<TextView>(R.id.button_next)?.apply {
            ...
            button_next.setOnClickListener(){
                ...
                findNavController().navigate(
                       Survey2EvaluateFragmentDirections.actionSurvey2EvaluateFragmentToSurvey3EvaluateFragment()
                )
            }
        }
    }
